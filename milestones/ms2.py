...
# -------------------------------------------------------------------------------
# Milestone 2 - Read MetaCritic urls from JSON file obtained in ms1 and place in list
        ...
        if(len(currentHrefs) == 0):
            ...
            for albumHref in currentHrefs: 
                ...
                if critRevCount > 0: # ensure reviews exist
                    ...
                    if critRevCount > len(criticScores): # ensure not to loop out of range
                        critRevCount = len(criticScores)
